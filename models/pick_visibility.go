...
func (s *PickVisibilityService) CalculateVisibility(game Game) PickVisibility {
	...
	case weekday == time.Sunday || weekday == time.Monday:
		// Sunday/Monday games become visible at 10:00 AM PT on Sunday
		var sunday time.Time
		if weekday == time.Sunday {
			// Sunday games become visible at 10:00 AM PT on Sunday (same day)
			sunday = gameDate
		} else {
			// Monday games become visible at 10:00 AM PT on the Sunday before
